...
public class BackgroundPaneWithClickThrough extends JPanel implements ActionListener, MouseMotionListener {
  ...
  public BackgroundPaneWithClickThrough(GifMaker gifMaker) {
...
//        selectionPane.setSize(0, 0);
      ...
      public void mouseDragged(MouseEvent e) {
        ...
        selectionPane.remove(jLabel);
        BackgroundPaneWithClickThrough.super.add(jPanel);
